# Generated by Powerlevel10k configuration wizard on 2026-01-09 at 15:18 EST.
...
() {
  ...
  # --- Russ Pop-Punk inspired palette (neon on black) ---
  typeset -g P10K_POPPUNK_BG=16        # near-black terminal bg
  typeset -g P10K_POPPUNK_FG=16        # black text on highlights
  typeset -g P10K_POPPUNK_NEON_TEAL=30 # optional teal
  typeset -g P10K_POPPUNK_NEON_BLUE=39 # neon blue for path
  typeset -g P10K_POPPUNK_NEON_PINK=205
  typeset -g P10K_POPPUNK_NEON_PURPLE=99
  typeset -g P10K_POPPUNK_NEON_YELLOW=220
  typeset -g P10K_POPPUNK_NEON_GREEN=40
  typeset -g P10K_POPPUNK_WARN=196

  # Directory: neon blue highlight, black text
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$P10K_POPPUNK_NEON_BLUE
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$P10K_POPPUNK_FG
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$P10K_POPPUNK_FG
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$P10K_POPPUNK_FG

  # Git: black text on neon yellow, black git icon + label
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=$P10K_POPPUNK_NEON_YELLOW
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=16
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=$P10K_POPPUNK_NEON_YELLOW
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=16
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=$P10K_POPPUNK_NEON_YELLOW
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=16
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=$P10K_POPPUNK_WARN
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_FOREGROUND=16
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_EXPANSION='%F{16}%f'
  typeset -g POWERLEVEL9K_VCS_PREFIX='%F{16}git%f '

  # Prompt arrow: bright white for success, red on error
  typeset -g POWERLEVEL9K_PROMPT_CHAR_BACKGROUND=
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_FOREGROUND=15
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_FOREGROUND=$P10K_POPPUNK_WARN

  # Right-side status/time: black text on neon pink
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=16
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=$P10K_POPPUNK_NEON_PINK
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=16
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=$P10K_POPPUNK_NEON_PINK
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=16
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=$P10K_POPPUNK_NEON_PINK
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=16
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=$P10K_POPPUNK_NEON_PINK
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=16
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=$P10K_POPPUNK_NEON_PINK

  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=16
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=$P10K_POPPUNK_NEON_PINK

  typeset -g POWERLEVEL9K_TIME_FOREGROUND=16
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=$P10K_POPPUNK_NEON_PINK
